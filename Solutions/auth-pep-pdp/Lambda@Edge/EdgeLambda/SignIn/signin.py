...
REGION = "eu-west-1"
APPLICATION_NAME = "pep-pdp-cognito"
...
param = ssm_client.get_parameter(Name=f"/{APPLICATION_NAME}/userPoolSecretName")
os.environ["USER_POOL_SECRET"] = param["Parameter"]["Value"]

param = ssm_client.get_parameter(Name=f"/{APPLICATION_NAME}/userPoolId")
os.environ["USER_POOL_ID"] = param["Parameter"]["Value"]

param = ssm_client.get_parameter(Name=f"/{APPLICATION_NAME}/userPoolEndpoint")
os.environ["USER_POOL_ENDPOINT"] = param["Parameter"]["Value"]

param = ssm_client.get_parameter(Name=f"/{APPLICATION_NAME}/userPoolHostedUi")
os.environ["USER_POOL_HOSTED_UI"] = param["Parameter"]["Value"]

param = ssm_client.get_parameter(Name=f"/{APPLICATION_NAME}/contentRoot")
